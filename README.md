...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/long-lab-7a42)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/long-lab-7a42
```

A live public deployment of this template is available at [https://long-lab-7a42.templates.workers.dev](https://long-lab-7a42.templates.workers.dev)
